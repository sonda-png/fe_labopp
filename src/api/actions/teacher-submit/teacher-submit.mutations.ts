...
const handleGradeSubmission =
  (client: AxiosInstance) => async (body: GradeSubmissionArgs) => {
    return (
      await client.post<TeacherSubmissionActionResponse>(
...
const handleFeedbackSubmission =
  (client: AxiosInstance) => async (body: FeedbackSubmissionArgs) => {
    return (
      await client.post<TeacherSubmissionActionResponse>(
