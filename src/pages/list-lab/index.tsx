...
const students = Array.from(new Set(submissions.map(s => s.student_name))).map(
  name => {
...
export default function SubmittedLabAssignments() {
  ...
  const filteredSubmissions = submissions.filter(submission => {
    const matchesStudent =
      studentFilter === 'all' || submission.student_name === studentFilter
    const matchesStatus =
      statusFilter === 'all' ||
      submission.status.toLowerCase() === statusFilter.toLowerCase()
    const matchesDate =
      !lastUploadedDate || submission.submitted_at.includes(lastUploadedDate)
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3">
                ...
                <p>Nguyen Van F - fnguyen@fpt.edu.vn</p>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="resubmit required">
                          Resubmit Required
                        </SelectItem>
                      </SelectContent>
                    </Select>
              ...
              <CardContent className="p-0">
                        ...
                        <TableRow key={submission.id}>
                          ...
                          <TableCell className="font-medium">
                            <div>
                              ...
                              {submission.manually_edited &&
                                submission.manual_reason && (
                                  <p className="text-xs text-orange-500 mt-1">
                                    Manual edit: {submission.manual_reason}
                                  </p>
                                )}
                            </div>
                          </TableCell>
                ...
                <div className="flex items-center justify-between p-4 border-t">
                  <div className="text-sm text-gray-500">
                    Showing {filteredSubmissions.length > 0 ? 1 : 0} to{' '}
                    {filteredSubmissions.length} of {filteredSubmissions.length}{' '}
                    entries
